...
namespace API_BOCHA_STORE.Migrations
{
    ...
    public partial class CreacionTablas : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Producto",
                columns: new[] { "idProducto", "descripcionProducto", "fechaCreacion", "idMarca", "idProovedor", "nombreProducto", "precio", "stock" },
                values: new object[,]
                {
                    { 1, "Camiseta Oversized", new DateTime(2023, 12, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, "Camiseta Negra", 19.989999999999998, 0 },
                    { 2, "Pantalon Deportivo", new DateTime(2023, 12, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 2, "Pantalon Negro", 15.99, 0 }
                });
